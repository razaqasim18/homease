...
@section('title')Seller || Profile @endsection
@section('head')
            ...
            <div class="card author-box">
                <div class="card-body">
                    <div class="author-box-center">
                        <?php $profile = (!empty(Auth::user()->image)) ? asset("uploads/seller") . '/' . Auth::user()->image : asset('assets/img/users/user-1.png');?>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-groupcol-md-6 col-12">
                                            <?php $image = (!empty(Auth::guard('seller')->user()->image)) ? asset("uploads/seller") . '/' . Auth::user()->image : "";?>
                                            <input type="hidden" name="showimage" id="showimage"
                                                <?php $showimage = (!empty(Auth::guard('seller')->user()->image)) ? Auth::guard('seller')->user()->image : '';?>
                                                value="{{ $showimage }}" />
...
$("button#profileButton").click(function() {
    ...
    var url = '{{ url("seller/profile/update") }}';
...
$("button#passwordButton").click(function() {
    ...
    var url = '{{ url("seller/profile/password/update") }}';
    var token = $("meta[name='csrf-token']").attr("content");
