        ...
        <div class="main-wrapper main-wrapper-1">
            ...
            <nav class="navbar navbar-expand-lg main-navbar sticky">
                ...
                <ul class="navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        <?php $profile = (!empty(Auth::guard('seller')->user()->image)) ? asset("uploads/seller") . '/' . Auth::guard('seller')->user()->image : asset('assets/img/users/user-1.png');?>
                        ...
                        <div class="dropdown-menu dropdown-menu-right pullDown">
                            ...
                            <a href="{{ route('seller.profile') }}" class="dropdown-item has-icon"> <i class="far
										fa-user"></i> Profile
                            </a>
