...
@section('title')Buyer || Profile @endsection
@section('head')
            ...
            <div class="card author-box">
                <div class="card-body">
                    <div class="author-box-center">
                        <?php $profile = (!empty(Auth::user()->image)) ? asset("uploads/buyer") . '/' . Auth::user()->image : asset('assets/img/users/user-1.png');?>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-groupcol-md-6 col-12">
                                            <?php $image = (!empty(Auth::guard('buyer')->user()->image)) ? asset("uploads/buyer") . '/' . Auth::user()->image : "";?>
                                            <input type="hidden" name="showimage" id="showimage"
                                                <?php $showimage = (!empty(Auth::guard('buyer')->user()->image)) ? Auth::guard('buyer')->user()->image : '';?>
                                                value="{{ $showimage }}" />
...
$("button#profileButton").click(function() {
    ...
    var url = '{{ url("buyer/profile/update") }}';
...
$("button#passwordButton").click(function() {
    ...
    var url = '{{ url("buyer/profile/password/update") }}';
    var token = $("meta[name='csrf-token']").attr("content");
